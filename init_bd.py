...
if __name__ == "__main__":
    ...
    asyncio.run(kb.fill_base(docs_path=sujet_path, collection_name=collection_name, rule_type='Rules'))
    asyncio.run(kb.fill_base(docs_path=collision_path, collection_name=collection_name, rule_type='Rules'))
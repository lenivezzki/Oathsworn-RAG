...
async def response(query: str, system_prompt, embedder: LaBSEEmbedder, knowledgbase: QdrantKnowledgeBase, collection_name:str, ranker: ChunksReranker, assistant: RulesAssistant, max_new_tokens:int=350):
    ...
    answer = await assistant.generate_response(query, context, system_prompt, max_new_tokens)
    return answer